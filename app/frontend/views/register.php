...
<form method="POST" action="?t=frontend&request=register">
    ...
    <div class="form-group row justify-content-center">
        <input type="date" class="form-control w-75 border border-dark <?php echo $model->hasError('birthdate') ? 'is-invalid' : ''?>" id="birthdate" name="birthdate" placeholder="Geburtsdatum">
        <?php
