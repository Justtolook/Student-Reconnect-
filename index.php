...
$app->router->setRoute("get", "frontend", "API_getEventNotification", [NotificationsController::class, 'API_getEventNotification'], 1);
...
$app->router->setRoute("post","frontend", "notifications/showEvent", [NotificationsController::class, 'showEvent'], 1);
